  ...
  static const unsigned char asso_values[] =
    {
      ...
      90, 90, 90, 90, 90, 90, 90, 90, 90, 90,
      90, 90, 90, 90, 90, 90, 90, 90, 90, 90,
      90, 90, 90, 90, 90, 10,  5, 90, 90, 90,
      90, 90, 90, 90, 90, 90, 90, 90, 90, 90,
      90, 90, 90, 90, 90, 90, 90, 90, 90, 90,
      90, 90, 90, 90, 90, 90, 90, 90, 90, 90,
      90, 90, 90, 90, 90, 90, 90, 90, 90, 90,
      90, 90, 90, 90, 90, 90, 90, 30,  5, 30,
      25,  0,  0, 10, 55, 10, 90, 10,  5, 40,
      25,  6, 15, 20, 20, 10,  0,  0, 20, 90,
...
static const struct TAG_cmd_option wordlist[] =
  {
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"output",			'o',	opt_setstr,		&(compopts.outfile),		"0output file-name",					49},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {"version",		'V',	opt_do_version,		NULL,				"0print version and exit",				45},
    ...
    {"verbose",		'v',	opt_setintflag,		&(compopts.verbose),		"0verbose compilation",					43},
    {"compile",		'c',	opt_setintflag,		&(compopts.notmainmodule),	"0compile for separate compilation",			46},
    {"extn",			'e',	opt_addextn,		NULL,				"0compiler extension to load",				53},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-parse",		'\0',	opt_setstopflag,	(void *)2,			"1stop after parse",					20},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-betrans",		'\0',	opt_setstopflag,	(void *)13,			"1stop after back-end tree transform",			31},
    {"stop-prescope",		'\0',	opt_setstopflag,	(void *)3,			"1stop after pre-scope",				21},
    {"stop-postcheck",		'\0',	opt_setstopflag,	(void *)11,			"1stop after post-check",				29},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"debug-parser",		'\0',	opt_setintflag,		&(compopts.debugparser),	"1debug parser",					44},
    ...
    {"dump-tracemem",		'\0',	opt_setintflag,		&(compopts.dumptracemem),	"1display left-over memory blocks (if compiled)",	54},
    ...
    {"trace-precode",		'\0',	opt_setintflag,		&(compopts.traceprecode),	"1trace pre-code (debugging)",				41},
    {"stop-constprop",		'\0',	opt_setstopflag,	(void *)6,			"1stop after constant propagation",			24},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"extn-path",		'E',	opt_addextnpath,	NULL,				"1add paths for compiler extensions",			52},
    {"stop-aliascheck",	'\0',	opt_setstopflag,	(void *)8,			"1stop after alias check",				26},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"trace-parser",		'\0',	opt_setintflag,		&(compopts.traceparser),	"1trace parser (debugging)",				39},
    {"stop-precheck",		'\0',	opt_setstopflag,	(void *)7,			"1stop after pre-check",				25},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-alloc",		'\0',	opt_setstopflag,	(void *)16,			"1stop after variable allocation",			34},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"dump-dmem",		'\0',	opt_setintflag,		&(compopts.dmemdump),		"1display dynamic memory pool information",		47},
    ...
    {"library-path",		'L',	opt_addlibrarypath,	NULL,				"0add paths for library files",				51},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"specs-file",		'\0',	opt_setstr,		&(compopts.specsfile),		"0path to compiler specs file",				48},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"save-all-dfas",		'\0',	opt_setstr,		&(compopts.savealldfas),	"1save all DFAs to file",				18},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"skip-usagecheck",	'\0',	opt_clearintflag,	&(compopts.dousagecheck),	"1skip parallel usage checks",				37},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"include-path",		'I',	opt_addincludepath,	NULL,				"0add paths for include files",				50},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"treecheck",		'\0',	opt_setintflag,		&(compopts.treecheck),		"1enable run-time parse tree checking",			42}
  };
