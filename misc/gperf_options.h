  ...
  static const unsigned char asso_values[] =
    {
      ...
      103, 103, 103, 103, 103, 103, 103, 103, 103, 103,
      103, 103, 103, 103, 103, 103, 103, 103, 103, 103,
      103, 103, 103, 103, 103,  30,   5, 103, 103, 103,
      103, 103, 103, 103, 103, 103, 103, 103, 103, 103,
      103, 103, 103, 103, 103, 103, 103, 103, 103, 103,
      103, 103, 103, 103, 103, 103, 103, 103, 103, 103,
      103, 103, 103, 103, 103, 103, 103, 103, 103, 103,
      103, 103, 103, 103, 103, 103, 103,  20,   5,   5,
       10,  45,   0,  20,  40,  10, 103,  10,  55,   5,
       10,  10,  15,   5,  20,  15,   0,   0,  35, 103,
...
static const struct TAG_cmd_option wordlist[] =
  {
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"output",			'o',	opt_setstr,		&(compopts.outfile),		"0output file-name",					40},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {"stop-undefcheck",	'\0',	opt_setstopflag,	(void *)9,			"1stop after undefined-usage check",			23},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-codegen",		'\0',	opt_setstopflag,	(void *)15,			"1stop after code-generation",				29},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-namemap",		'\0',	opt_setstopflag,	(void *)12,			"1stop after name-map",					26},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-fetrans",		'\0',	opt_setstopflag,	(void *)10,			"1stop after front-end tree transform",			24},
    {"stop-prescope",		'\0',	opt_setstopflag,	(void *)3,			"1stop after pre-scope",				17},
    {"dump-dmem",		'\0',	opt_setintflag,		&(compopts.dmemdump),		"1display dynamic memory pool information",		38},
    ...
    {"stop-betrans",		'\0',	opt_setstopflag,	(void *)11,			"1stop after back-end tree transform",			25},
    {"stop-prealloc",		'\0',	opt_setstopflag,	(void *)13,			"1stop after pre-allocation",				27},
    {"extn-path",		'E',	opt_addextnpath,	NULL,				"1add paths for compiler extensions",			43},
    ...
    {"include-path",		'I',	opt_addincludepath,	NULL,				"0add paths for include files",				41},
    {"stop-precheck",		'\0',	opt_setstopflag,	(void *)6,			"1stop after pre-check",				20},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-aliascheck",	'\0',	opt_setstopflag,	(void *)7,			"1stop after alias check",				21},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"dump-grammar",		'\0',	opt_setintflag,		&(compopts.dumpgrammar),	"1print grammars during parser init",			5},
    {"skip-defcheck",		'\0',	opt_clearintflag,	&(compopts.dodefcheck),		"1skip undefinedness checks",				32},
    {"save-named-dfa",		'\0',	opt_setsaveopt,		(void *)1,			"1save named DFA to file",				13},
    {"stop-alloc",		'\0',	opt_setstopflag,	(void *)14,			"1stop after variable allocation",			28},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"library-path",		'L',	opt_addlibrarypath,	NULL,				"0add paths for library files",				42},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"help",			'h',	opt_do_help_flag,	NULL,				"0display standard usage information",			0},
    {"skip-aliascheck",	'\0',	opt_clearintflag,	&(compopts.doaliascheck),	"1skip alias checks",					30},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-usagecheck",	'\0',	opt_setstopflag,	(void *)8,			"1stop after parallel-usage check",			22},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"specs-file",		'\0',	opt_setstr,		&(compopts.specsfile),		"0path to compiler specs file",				39},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"version",		'V',	opt_do_version,		NULL,				"0print version and exit",				36},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"skip-usagecheck",	'\0',	opt_clearintflag,	&(compopts.dousagecheck),	"1skip parallel usage checks",				31},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"verbose",		'v',	opt_setintflag,		&(compopts.verbose),		"0verbose compilation",					34},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"trace-typecheck",	'\0',	opt_setintflag,		&(compopts.tracetypecheck),	"1trace type-check (debugging)",			33},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"compile",		'c',	opt_setintflag,		&(compopts.notmainmodule),	"0compile for separate compilation",			37},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"debug-parser",		'\0',	opt_setintflag,		&(compopts.debugparser),	"1debug parser",					35}
  };
