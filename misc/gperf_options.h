  ...
  static const unsigned char asso_values[] =
    {
      ...
      83, 83, 83, 83, 83, 83, 83, 83, 83, 83,
      83, 83, 83, 83, 83, 83, 83, 83, 83, 83,
      83, 83, 83, 83, 83,  0,  5, 83, 83, 83,
      83, 83, 83, 83, 83, 83, 83, 83, 83, 83,
      83, 83, 83, 83, 83, 83, 83, 83, 83, 83,
      83, 83, 83, 83, 83, 83, 83, 83, 83, 83,
      83, 83, 83, 83, 83, 83, 83, 83, 83, 83,
      83, 83, 83, 83, 83, 83, 83, 20,  5, 25,
      10, 45,  0, 25, 40, 10, 83, 10,  0,  5,
      10, 10, 15, 45, 15, 15,  0,  0, 35, 83,
...
static const struct TAG_cmd_option wordlist[] =
  {
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"compile",		'c',	opt_setintflag,		&(compopts.notmainmodule),	"0compile for separate compilation",			39},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {"dump-dmem",		'\0',	opt_setintflag,		&(compopts.dmemdump),		"1display dynamic memory pool information",		40},
    {"specs-file",		'\0',	opt_setstr,		&(compopts.specsfile),		"0path to compiler specs file",				41},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {"extn-path",		'E',	opt_addextnpath,	NULL,				"1add paths for compiler extensions",			45},
    ...
    {"trace-parser",		'\0',	opt_setintflag,		&(compopts.traceparser),	"1trace parser (debugging)",				34},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"version",		'V',	opt_do_version,		NULL,				"0print version and exit",				38},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"skip-usagecheck",	'\0',	opt_clearintflag,	&(compopts.dousagecheck),	"1skip parallel usage checks",				32},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"verbose",		'v',	opt_setintflag,		&(compopts.verbose),		"0verbose compilation",					36},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-scope",		'\0',	opt_setstopflag,	(void *)4,			"1stop after scope",					18},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"debug-parser",		'\0',	opt_setintflag,		&(compopts.debugparser),	"1debug parser",					37},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"trace-typecheck",	'\0',	opt_setintflag,		&(compopts.tracetypecheck),	"1trace type-check (debugging)",			35},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"include-path",		'I',	opt_addincludepath,	NULL,				"0add paths for include files",				43},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"library-path",		'L',	opt_addlibrarypath,	NULL,				"0add paths for library files",				44}
  };
