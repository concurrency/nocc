  ...
  static const unsigned char asso_values[] =
    {
      ...
      129, 129, 129, 129, 129, 129, 129, 129, 129, 129,
      129, 129, 129, 129, 129, 129, 129, 129, 129, 129,
      129, 129, 129, 129, 129,  10, 129,   0, 129, 129,
      129, 129, 129, 129, 129, 129, 129, 129, 129, 129,
      129, 129, 129, 129, 129, 129, 129, 129, 129, 129,
      129, 129, 129, 129, 129, 129, 129, 129, 129, 129,
      129, 129, 129, 129, 129, 129, 129, 129, 129, 129,
      129, 129, 129, 129, 129, 129, 129,  15,   5,  15,
       60,   5,  55,  10,   0,   0,   5,  50,   0,   0,
       20,   1,  20,  55,  30,  35,   0,   0,  15, 129,
...
static const struct TAG_cmd_option wordlist[] =
  {
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"output",			'o',	opt_setstr,		&(compopts.outfile),		"0output file-name",					303},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {"stop-undefcheck",	'\0',	opt_setstopflag,	(void *)10,			"1stop after undefined-usage check",			109},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {"dump-extns",		'\0',	opt_setintflag,		&(compopts.dumpextns),		"1print detailed information about loaded extensions",	16},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"stop-codegen",		'\0',	opt_setstopflag,	(void *)17,			"1stop after code-generation",				116},
    ...
    {"specs-file",		'\0',	opt_setstr,		&(compopts.specsfile),		"0path to compiler specs file",				302},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"trace-precode",		'\0',	opt_setintflag,		&(compopts.traceprecode),	"1trace pre-code (debugging)",				202},
    ...
    {"dump-chooks",		'\0',	opt_setintflag,		&(compopts.dumpchooks),		"1print compiler hooks",				15},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    ...
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {(char*)0,'\0',NULL,NULL,NULL,-1},
    {"dump-folded",		'\0',	opt_setintflag,		&(compopts.dumpfolded),		"1include folds in parse tree dumps",			17},
